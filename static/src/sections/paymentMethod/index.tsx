...
export const PaymentMethodPanel = () => {
    ...
    return (
        ...
        >
            ...
            <Box>
                <Typography variant="h5" sx={{ mb: 2 }}>Update your Card</Typography>
                {!paymentMethod ? (
                    <Box sx={{ mt: 2, mb: 2 }}>
                        <CardElement
                    ...
                    <Box sx={{ mt: 2, mb: 2 }}>
                        <Typography variant="body2" sx={{ mb: 2 }}>
                            Current payment method: {paymentMethod.brand.toUpperCase()} ending in{" "}
                ...
                <Typography variant="h5" sx={{ mb: 2 }}>{subtitle}</Typography>
                {subscribeError && (
