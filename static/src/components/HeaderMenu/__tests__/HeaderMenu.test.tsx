...
describe('HeaderMenu', () => {
  ...
  describe('Rendering', () => {
    it('should render the RichDocter logo', () => {
      render(<HeaderMenu />);
  ...
  describe('Story Title Editing', () => {
    it('should update story title on edit', async () => {
      ...
      vi.mocked(api.api.put).mockResolvedValue({ status: 200, data: {} } as any);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle error without message property', async () => {
      ...
      await waitFor(() => {
        expect(mockSetAlertState).toHaveBeenCalledWith(
          expect.objectContaining({
            message: 'There was an error updating your story title. Please report this.',
          })
        );
      });
    });
