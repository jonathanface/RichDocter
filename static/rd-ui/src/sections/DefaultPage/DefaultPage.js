        ...
        <div className="default-page">
            <div className="blurb">
                ...
                <span className="column">
                    <figure>
                    <iframe src="https://www.youtube.com/embed/Jr2IjkhCrBQ?si=KQ3FpPMWlbAO1qSN?autoplay=1&muted=1&controls=0" title="RichDocter Demo" frameborder="0" allow="autoplay" allowfullscreen></iframe>
                    </figure>
                </span>
            </div>
            <div className="blurb">
