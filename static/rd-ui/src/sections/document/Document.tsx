...
import { Association, AttributeMap, DocumentBlockStyle, DocumentTab } from "../../types";
...
const Document = () => {
  ...
  const handleAssociationContextMenu = (name: string, type: number, event: MouseEvent) => {
  ...
  const formatBlankAssociation = (type: number, name: string) => {
    return {
      association_id: "",
