import { Box, Checkbox, Dialog, DialogContent, DialogTitle, List, ListItem, ListItemText } from "@mui/material";
...
export const DocumentSettingsModal = ({ open, setOpen }: DocumentSettingsProps) => {
