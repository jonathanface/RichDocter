    ...
    <nav className="rich-controls">
      <div>
        <span className="controls-row">
          <button
            className={currentFormatting.bold ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState(TextFormatType.bold, true);
              props.updateStyle(e, TextFormatType.bold);
            }}>
            <b>B</b>
          </button>
          <button
            className={currentFormatting.italic ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState(TextFormatType.italic, true);
              props.updateStyle(e, TextFormatType.italic);
            }}>
            <i>I</i>
          </button>
          <button
            className={currentFormatting.underscore ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState(TextFormatType.underscore, true);
              props.updateStyle(e, TextFormatType.underscore);
            }}>
            <u>U</u>
          </button>
          <button
            className={currentFormatting.strikethrough ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState(TextFormatType.strikethrough, true);
        ...
        <span className="controls-row">
          <button
            className={currentBlockAlignment === BlockAlignmentType.left ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState("alignment", BlockAlignmentType.left);
              props.updateAlignment(e, BlockAlignmentType.left);
            }}>
            <FontAwesomeIcon icon={faAlignLeft} />
          </button>
          <button
            className={currentBlockAlignment === BlockAlignmentType.center ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState("alignment", BlockAlignmentType.center);
              props.updateAlignment(e, BlockAlignmentType.center);
            }}>
            <FontAwesomeIcon icon={faAlignCenter} />
          </button>
          <button
            className={currentBlockAlignment === BlockAlignmentType.right ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState("alignment", BlockAlignmentType.right);
              props.updateAlignment(e, BlockAlignmentType.right);
            }}>
            <FontAwesomeIcon icon={faAlignRight} />
          </button>
          <button
            className={currentBlockAlignment === BlockAlignmentType.justify ? "active" : ""}
            onMouseDown={(e) => {
              setNavButtonState("alignment", BlockAlignmentType.justify);
              props.updateAlignment(e, BlockAlignmentType.justify);
            }}>
